...
export const APP_CONFIG = {
	...
	APP_VERSION: "1.0.0",
	APP_VERSION_CODE: 1,
	APP_FETCH_URL: MODE_CONFIG[MODE.DEVELOPMENT].APP_FETCH_URL,
	APP_TUG_URL: MODE_CONFIG[MODE.DEVELOPMENT].APP_TUG_URL,
	APP_YOUNGHEE_URL: 	MODE_CONFIG[MODE.DEVELOPMENT].APP_YOUNGHEE_URL,

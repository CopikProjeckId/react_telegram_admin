...
export default function TugExchange() {
                ...
                {exchange.success == 0 && (
                  ...
                  >
                    <Button
                      ...
                      onClick={() => {
                        DataCall.getInstance()
                          .updateExchange(exchange.id ?? "", 1, "tug")
                          .then((res) => {
                            console.log(res);
                            fetchExchangeData();
                          });
                    ...
                    <Button
                      ...
                      onClick={() => {
                        DataCall.getInstance()
                          .updateExchange(exchange.id ?? "", 2, "tug")
                          .then((res) => {
                            console.log(res);
                            fetchExchangeData();
                          });

...
import NotificationList from "../Router/Pages/Notification/NotificationList";
import CreateNotification from "../Router/Pages/Notification/CreateNotification";
...
export const ROUTES_COMPONENTS: Record<string, React.ReactNode> = {
  ...
  [ROUTES.NOTIFICATION_LIST]: <NotificationList />,
  [ROUTES.NOTIFICATION_CREATE]: <CreateNotification />,
};
